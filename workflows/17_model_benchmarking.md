...
run controlled benchmarks and feed validated results into routing policy.
...
Pre-registered benchmark suite, metrics, fixed configurations, and budget.
...
Reproducible benchmark artifacts, results, limitations, and capability-matrix updates.
...
Stop on contaminated benchmarks, missing baselines, or nonreproducible results. Escalate policy-impacting anomalies to routing_auditor.
