...
identify relevant primary literature and map each cited assertion to a source.
...
Formalized problem and search plan.
...
A source ledger with stable metadata, exact claim support, quotation/location notes, and confidence limits.
...
Stop when sources are inaccessible or attribution remains uncertain. Escalate all source conflicts to reference_auditor.
