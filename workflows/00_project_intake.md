...
register the research question, participants, deliverables, risks, and initial claim ledger.
...
A signed intake brief with problem statement, intended scope, constraints, data/source inventory, budget, and named orchestrator.
...
No work begins without IDs, truth-layer labels, ownership, and an explicit definition of success.
...
Stop on missing ownership, incompatible goals, or an unbounded question. Escalate ambiguity or conflicting constraints to the project sponsor and orchestrator.
