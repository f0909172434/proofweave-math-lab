...
try to refute targets and test sharpness of hypotheses.
...
Formal claim, parameter ranges, and known special cases.
...
A reproducible counterexample report, including negative searches clearly labeled as non-proof.
...
Stop after budget or decisive example. Escalate any counterexample or hypothesis failure immediately.
